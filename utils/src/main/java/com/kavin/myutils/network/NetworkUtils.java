...
public final class NetworkUtils {
    ...
    public static NetworkTask.Task<Boolean> isAvailableAsync(@NonNull final NetworkTask.Consumer<Boolean> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final NetworkTask.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static NetworkTask.Task<Boolean> isAvailableByPingAsync(final String ip,
                                                                   @NonNull final NetworkTask.Consumer<Boolean> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final NetworkTask.Consumer<Boolean> consumer) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static NetworkTask.Task isAvailableByDnsAsync(final String domain,
                                                         @NonNull final NetworkTask.Consumer<Boolean> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static NetworkTask.Task<Boolean> isWifiAvailableAsync(@NonNull final NetworkTask.Consumer<Boolean> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<Boolean>(consumer) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return the task
     */
    public static NetworkTask.Task<String> getIPAddressAsync(final boolean useIPv4,
                                                             @NonNull final NetworkTask.Consumer<String> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static NetworkTask.Task<String> getDomainAddressAsync(final String domain,
                                                                 @NonNull final NetworkTask.Consumer<String> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
