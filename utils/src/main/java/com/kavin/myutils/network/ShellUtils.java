...
public final class ShellUtils {
     ...
     * @return the task
     */
    public static NetworkTask.Task<CommandResult> execCmdAsync(final String command,
                                                               final boolean isRooted,
                                                               final NetworkTask.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static NetworkTask.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                               final boolean isRooted,
                                                               final NetworkTask.Consumer<CommandResult> consumer) {
     ...
     * @return the task
     */
    public static NetworkTask.Task<CommandResult> execCmdAsync(final String[] commands,
                                                               final boolean isRooted,
                                                               final NetworkTask.Consumer<CommandResult> consumer) {
    ...
    public static NetworkTask.Task<CommandResult> execCmdAsync(final String[] commands,
                                                               final boolean isRooted,
                                                               final boolean isNeedResultMsg,
                                                               @NonNull final NetworkTask.Consumer<CommandResult> consumer) {
        return NetworkTask.doAsync(new NetworkTask.Task<CommandResult>(consumer) {
            @Override
