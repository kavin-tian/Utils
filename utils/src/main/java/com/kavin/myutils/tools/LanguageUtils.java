...
public class LanguageUtils {
    ...
    private static void applyLanguage(@NonNull final Locale locale,
                                      ...
                                      final boolean isNeedStartActivity) {
        if (isFollowSystem) {
            SPUtils.getSpUtils4Utils().put(KEY_LOCALE, VALUE_FOLLOW_SYSTEM);
        } else {
            SPUtils.getSpUtils4Utils().put(KEY_LOCALE, locale2String(locale));
        }
        ...
        if (isNeedStartActivity) {
            ...
            String realActivityClassName = TextUtils.isEmpty(activityClassName) ? getLauncherActivity(Utils.getApp().getPackageName()) : activityClassName;
    ...
    public static boolean isAppliedSystemLanguage() {
        return VALUE_FOLLOW_SYSTEM.equals(SPUtils.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static boolean isAppliedLanguage() {
        return !TextUtils.isEmpty(SPUtils.getSpUtils4Utils().getString(KEY_LOCALE));
    }
    ...
    public static boolean isAppliedLanguage(Locale locale) {
        final String spLocale = SPUtils.getSpUtils4Utils().getString(KEY_LOCALE);
    ...
    static void applyLanguage(@NonNull final Activity activity) {
        String spLocale = SPUtils.getSpUtils4Utils().getString(KEY_LOCALE);
        if (TextUtils.isEmpty(spLocale)) {
            return;
        }
